...
{
  // With timestamp_state_interfaces set, header.stamp comes from those interfaces, not from the
  ...
  // Different controller-manager time: the published stamp must NOT equal it.
  ASSERT_EQ(
